...
@interface StyleNineVC () <SGSegmentedControlDefaultDelegate, UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.topSView = [SGSegmentedControlDefault segmentedControlWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 44) delegate:self childVcTitle:title_arr isScaleText:YES];
