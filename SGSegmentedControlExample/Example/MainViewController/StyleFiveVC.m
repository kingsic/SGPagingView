...
- (void)setupSegmentedControl {
    ...
    self.SG = [SGSegmentedControl segmentedControlWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 74) delegate:nil segmentedControlType:(SGSegmentedControlTypeStatic) nomalImageArr:nomal_image_arr selectedImageArr:selected_image_arr titleArr:title_arr];
