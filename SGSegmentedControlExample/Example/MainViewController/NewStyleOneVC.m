...
@interface NewStyleOneVC () <SGSegmentedControlStaticDelegate, UIScrollViewDelegate>
...
- (void)viewDidLoad {
    ...
    self.topSView = [SGSegmentedControlStatic segmentedControlWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 44) delegate:self childVcTitle:title_arr indicatorIsFull:NO];
    // 必须实现的方法
