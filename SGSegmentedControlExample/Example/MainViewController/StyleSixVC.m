...
@interface StyleSixVC ()<UIScrollViewDelegate, SGSegmentedControlDelegate>
@property (nonatomic, strong) SGSegmentedControl *SG;
@property (nonatomic, strong) UIScrollView *mainScrollView;
@end

@implementation StyleSixVC
...
- (void)setupSegmentedControl {
    ...
    self.SG = [SGSegmentedControl segmentedControlWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 74) delegate:self segmentedControlType:(SGSegmentedControlTypeScroll) nomalImageArr:nomal_image_arr selectedImageArr:selected_image_arr titleArr:title_arr];
