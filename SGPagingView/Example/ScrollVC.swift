...
class ScrollVC: UIViewController, SGPagingTitleViewDelegate, SGPagingContentViewDelegate {
    ...
    lazy var pagingTitleView: SGPagingTitleView = {
        ...
        let titles = ["关注", "推荐", "热榜", "免费小说", "财经", "问答", "科技", "要闻"]
    ...
    lazy var pagingContentView: SGPagingContentCollectionView = {
        ...
        vc6.view.backgroundColor = .orange
        let vc7 = UIViewController()
        vc7.view.backgroundColor = .green
        let vc8 = UIViewController()
        vc8.view.backgroundColor = .brown
        let vcs = [vc1, vc2, vc3, vc4, vc5, vc6, vc7, vc8]
